    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          overlayClassName="bg-black/15 dark:bg-black/25 backdrop-blur-sm"
          className="sidebar-mobile-surface text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden rounded-[18px] overflow-hidden border border-sidebar-border/70 h-auto bg-sidebar/80 backdrop-blur-xl shadow-[0_10px_36px_rgba(15,23,42,0.22),0_2px_8px_rgba(15,23,42,0.14)]"
    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            "flex h-full w-full flex-col overflow-hidden rounded-[18px] border border-sidebar-border/70 bg-sidebar/80 backdrop-blur-xl ring-1 ring-white/10",
            variant === "floating"
              ? "shadow-[0_18px_38px_rgba(15,23,42,0.14)]"
              : "dark:bg-[hsl(var(--sidebar)/0.82)] shadow-[inset_0_1px_0_hsl(var(--background)/0.12)] group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm",
            innerClassName
          )}
          style={innerStyle}
        >
