...
type RecentPageId = "route-list" | "deliveries" | "rooster" | "plano-vm" | "gallery-album" | "gallery-site-images" | "settings-profile" | "bot-dashboard" | "bot-profile"
...
const PAGE_OPTIONS: Record<RecentPageId, RecentPageOption> = {
  ...
  "bot-dashboard": { id: "bot-dashboard", icon: MessageCircle, label: "Account", iconClass: "text-green-600" },
  "bot-profile": { id: "bot-profile", icon: Users, label: "Profile", iconClass: "text-emerald-600" },
}
